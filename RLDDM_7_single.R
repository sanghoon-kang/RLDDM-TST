...
# init_list = list(c1=list(alpha = rep(0.2,N), p = rep(0,N), b = rep(3,N)), 
#                  c2=list(alpha = rep(0.2,N), p = rep(0,N), b = rep(3,N)),
#                  c3=list(alpha = rep(0.2,N), p = rep(0,N), b = rep(3,N)),
#                  c4=list(alpha = rep(0.2,N), p = rep(0,N), b = rep(3,N)))


# run! (model-fitting + multiple simulations for ppc)
model1 = stan("RLDDM_7_single.stan", data = dataList1, pars = c("alpha", "p", "omega", "lambda", 
                                                                "a", "b", "tau",
                                                                "rt1","rt2","ch1","ch2","arwrd","asecstagestate","trn"),
              iter = 4000, warmup=2000, chains=4, cores=4, verbose=FALSE)
...
for (i in 1:N){
  png(file=paste("model1_",i,"_traceplot.png",sep=''),width=600, height=350)
  t<-traceplot(model1, pars=c(paste('alpha[',i,']',sep=''),paste('p[',i,']',sep=''),paste('omega[',i,']',sep=''),
...
# print summary
print(model1, pars=c("alpha"), include=TRUE)
print(model1, pars=c("p"), include=TRUE)
print(model1, pars=c("lambda"), include=TRUE)
print(model1, pars=c("omega"), include=TRUE)
print(model1, pars=c("a"), include=TRUE)
print(model1, pars=c("b"), include=TRUE)
print(model1, pars=c("tau"), include=TRUE)


# extract Stan fit object (parameters)
parameters <- rstan::extract(model1)

library(bayesplot)

png(file="model1_alpha_posterior.png",width=2000, height=1200)
plot(model1, plotfun = "hist", pars = c("alpha"), include = TRUE)
dev.off()
png(file="model1_p_posterior.png",width=2000, height=1200)
plot(model1, plotfun = "hist", pars = c("p"), include = TRUE)
dev.off()
png(file="model1_omega_posterior.png",width=2000, height=1200)
plot(model1, plotfun = "hist", pars = c("omega"), include = TRUE)
dev.off()
png(file="model1_lambda_posterior.png",width=2000, height=1200)
plot(model1, plotfun = "hist", pars = c("lambda"), include = TRUE)
dev.off()
png(file="model1_a_posterior.png",width=2000, height=1200)
plot(model1, plotfun = "hist", pars = c('a'), include = TRUE)
dev.off()
png(file="model1_b_posterior.png",width=1000, height=600)
plot(model1, plotfun = "hist", pars = c('b'), include = TRUE)
dev.off()
png(file="model1_tau_posterior.png",width=1000, height=600)
plot(model1, plotfun = "hist", pars = c('tau'), include = TRUE)
dev.off()
...
for (i in 1:N){
  png(file=paste("RLDDM_7_single_ch1_subject",i,"__ppc.png",sep=''),width=600, height=350)
  ch1<-ppc_bars(unlist(choice1[i]), matrix(ch1_rep[,i,],ncol=T), freq=FALSE)
  print(ch1)
  dev.off()
  png(file=paste("RLDDM_7_single_ch2_subject",i,"__ppc.png",sep=''),width=600, height=350)
  ch2<-ppc_bars(unlist(choice2[i]), matrix(ch2_rep[,i,],ncol=T), freq=FALSE)
  print(ch2)
  dev.off()
  png(file=paste("RLDDM_7_single_rt1_subject",i,"__ppc.png",sep=''),width=600, height=350)
  rt1<-ppc_stat(unlist(RT1[i]), matrix(rt1_rep[,i,],ncol=T)) 
  print(rt1)
  dev.off()
  png(file=paste("RLDDM_7_single_rt2_subject",i,"__ppc.png",sep=''),width=600, height=350)
...
model1_gen_1000 = stan("RLDDM_7_sim.stan", data = dataList1_sim, pars = c("rt1","rt2","ch1","ch2","arwrd","asecstagestate","trn"),
                       iter = 1, chains=1, cores=1, algorithm="Fixed_param")

print(model1_gen_1000)

parameters_gen_1000 <- rstan::extract(model1_gen_1000)
...
model1_recovery = stan("RLDDM_7_single.stan", data = dataList1_recovery, pars = c("alpha", "p", "omega", "lambda", 
                                                                                  "a", "b", "tau"),
                       iter = 4000, warmup=2000, chains=4, cores=4)

parameters_recovery <- rstan::extract(model1_recovery)
...
alpha_corr
png(file="RLDDM_7_single_alpha_recovery_1000.png",width=600, height=350)
...
p_corr
png(file="RLDDM_7_single_p_recovery_1000.png",width=600, height=350)
...
omega_corr
png(file="RLDDM_7_single_omega_recovery_1000.png",width=600, height=350)
...
lambda_corr
png(file="RLDDM_7_single_lambda_recovery_1000.png",width=600, height=350)
...
a_corr
png(file="RLDDM_7_single_a_recovery_1000.png",width=600, height=350)
...
b_corr
png(file="RLDDM_7_single_b_recovery_1000.png",width=600, height=350)
...
tau_corr
png(file="RLDDM_7_single_tau_recovery_1000.png",width=600, height=350)
...
model1_gen_800 = stan("RLDDM_7_sim.stan", data = dataList1_sim, pars = c("rt1","rt2","ch1","ch2","arwrd","asecstagestate","trn"),
                      iter = 1, chains=1, cores=1, algorithm="Fixed_param")

print(model1_gen_800)

parameters_gen_800 <- rstan::extract(model1_gen_800)
...
# Let's fit the simulated data
model1_recovery_800 = stan("RLDDM_7_single.stan", data = dataList1_recovery_800, pars = c("alpha", "p", "omega", "lambda", 
                                                                                          "a", "b", "tau"),
                           iter = 4000, warmup=2000, chains=4, cores=4)

parameters_recovery_800 <- rstan::extract(model1_recovery_800)
...
png(file="RLDDM_7_single_alpha_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=alpha, y=alpha_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_p_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=p, y=p_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_omega_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=omega, y=omega_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_lambda_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=lambda, y=lambda_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_a_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=a, y=a_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_b_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=b, y=b_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_tau_recovery_800.png",width=600, height=350)
ggplot(allparams, aes(x=tau, y=tau_r)) + geom_point()
dev.off()
...
model1_gen_600 = stan("RLDDM_7_sim.stan", data = dataList1_sim, pars = c("rt1","rt2","ch1","ch2","arwrd","asecstagestate","trn"),
                      iter = 1, chains=1, cores=1, algorithm="Fixed_param")

print(model1_gen_600)

parameters_gen_600 <- rstan::extract(model1_gen_600)
...
# Let's fit the simulated data
model1_recovery_600 = stan("RLDDM_7_single.stan", data = dataList1_recovery_600, pars = c("alpha", "p", "omega", "lambda", 
                                                                                          "a", "b", "tau"),
                           iter = 4000, warmup=2000, chains=4, cores=4)

parameters_recovery_600 <- rstan::extract(model1_recovery_600)
...
png(file="RLDDM_7_single_alpha_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=alpha, y=alpha_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_p_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=p, y=p_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_omega_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=omega, y=omega_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_lambda_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=lambda, y=lambda_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_a_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=a, y=a_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_b_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=b, y=b_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_tau_recovery_600.png",width=600, height=350)
ggplot(allparams, aes(x=tau, y=tau_r)) + geom_point()
dev.off()
...
model1_gen_400 = stan("RLDDM_7_sim.stan", data = dataList1_sim, pars = c("rt1","rt2","ch1","ch2","arwrd","asecstagestate","trn"),
                      iter = 1, chains=1, cores=1, algorithm="Fixed_param")

print(model1_gen_400)

parameters_gen_400 <- rstan::extract(model1_gen_400)
...
# Let's fit the simulated data
model1_recovery_400 = stan("RLDDM_7_single.stan", data = dataList1_recovery_400, pars = c("alpha", "p", "omega", "lambda", 
                                                                                          "a", "b", "tau"),
                           iter = 4000, warmup=2000, chains=4, cores=4)

parameters_recovery_400 <- rstan::extract(model1_recovery_400)
...
png(file="RLDDM_7_single_alpha_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=alpha, y=alpha_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_p_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=p, y=p_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_omega_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=omega, y=omega_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_lambda_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=lambda, y=lambda_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_a_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=a, y=a_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_b_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=b, y=b_r)) + geom_point()
dev.off()

png(file="RLDDM_7_single_tau_recovery_400.png",width=600, height=350)
ggplot(allparams, aes(x=tau, y=tau_r)) + geom_point()
dev.off()
...
model1_gen_200 = stan("RLDDM_7_sim.stan", data = dataList1_sim, pars = c("rt1","rt2","ch1","ch2","arwrd","asecstagestate","trn"),
                      iter = 1, chains=1, cores=1, algorithm="Fixed_param")

print(model1_gen_200)

parameters_gen_200 <- rstan::extract(model1_gen_200)
...
# Let's fit the simulated data
model1_recovery_200 = stan("RLDDM_7_single.stan", data = dataList1_recovery_200, pars = c("alpha", "p", "omega", "lambda", 
                                                                                          "a", "b", "tau"),
                           iter = 3000, warmup=1000, chains=4, cores=4)

parameters_recovery_200 <- rstan::extract(model1_recovery_200)
...
alpha_corr<-round(cor(allparams$alpha, allparams$alpha_r),digits=3)
alpha_corr
png(file="RLDDM_7_single_alpha_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=alpha, y=alpha_r)) + geom_point() +
  geom_smooth(method=lm) +
  ggtitle('alpha_recovery_200') +
  geom_text(x=median(alpha_mean),y=max(alpha_recovered_mean),
            label = paste("r=",alpha_corr))
dev.off()
...
p_corr<-round(cor(allparams$p, allparams$p_r),digits=3)
p_corr
png(file="RLDDM_7_single_p_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=p, y=p_r)) + geom_point() +
  geom_smooth(method=lm) +
...
omega_corr<-round(cor(allparams$omega, allparams$omega_r),digits=3)
omega_corr
png(file="RLDDM_7_single_omega_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=omega, y=omega_r)) + geom_point() +
  geom_smooth(method=lm) +
...
lambda_corr<-round(cor(allparams$lambda, allparams$lambda_r),digits=3)
lambda_corr
png(file="RLDDM_7_single_lambda_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=lambda, y=lambda_r)) + geom_point() +
  geom_smooth(method=lm) +
...
a_corr<-round(cor(allparams$a, allparams$a_r),digits=3)
a_corr
png(file="RLDDM_7_single_a_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=a, y=a_r)) + geom_point() +
  geom_smooth(method=lm) +
  ggtitle('a_recovery_200') +
  geom_text(x=median(a_mean),y=max(a_recovered_mean),
            label = paste("r=",a_corr))
dev.off()
...
b_corr<-round(cor(allparams$b, allparams$b_r),digits=3)
b_corr
png(file="RLDDM_7_single_b_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=b, y=b_r)) + geom_point() +
  geom_smooth(method=lm) +
  ggtitle('b_recovery_200') +
  geom_text(x=median(b_mean),y=max(b_recovered_mean),
            label = paste("r=",b_corr))
dev.off()
...
tau_corr<-round(cor(allparams$tau, allparams$tau_r),digits=3)
tau_corr
png(file="RLDDM_7_single_tau_recovery_200.png",width=600, height=350)
ggplot(allparams, aes(x=tau, y=tau_r)) + geom_point() +
  geom_smooth(method=lm) +
  ggtitle('tau_recovery_200') +
  geom_text(x=median(tau_mean),y=max(tau_recovered_mean),
            label = paste("r=",tau_corr))
dev.off()
